# CLAUDE.md — Interactive Artifact Tool (HO5)
...
## About this project
An interactive tool (calculator / quiz / explainer) you generate as a Claude Artifact.
**Primary way to do it:** Claude.ai chat (build it as an Artifact) — **no API key needed.**
...
- It's the **Interactive Artifact Tool** hands-on. Self-contained HTML tools — no API key.
